...
@section('content')
    <div class="rounded-2xl bg-white p-6 shadow-sm">
        <h1 class="text-xl font-semibold text-gray-800">Apa itu Banjar?</h1>
        <p class="mt-3 text-gray-600">
            Banjar adalah satuan komunitas terkecil dalam masyarakat adat Bali, kumpulan keluarga yang tinggal
            dalam satu wilayah dan mengurus kegiatan bersama, mulai dari upacara adat, gotong royong, sampai
            urusan lingkungan sehari-hari.
        </p>
    </div>

    <div class="mt-8">
        <h2 class="text-xl font-semibold text-gray-800">Daftar Banjar</h2>
            ...
            <div class="overflow-hidden rounded-2xl bg-white shadow-sm">
                ...
                <div class="p-5">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        {{ $banjar->family_count }} Keluarga terdaftar &middot; {{ $banjar->users_count }} warga aktif di sistem
                    </p>
                </div>
            </div>
        @endforeach
