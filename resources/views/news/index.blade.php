    ...
    @if ($featured)
        <div class="mt-6 grid grid-cols-1 overflow-hidden rounded-2xl bg-white shadow-sm lg:grid-cols-2">
            ...
            <div class="p-6">
                ...
                <p class="mt-3 text-gray-600">{{ \Illuminate\Support\Str::limit($featured->content, 320) }}</p>

                <div class="mt-6 flex items-center gap-3">
                    <x-avatar :name="$featured->author->name" size="h-9 w-9 text-sm" />
        ...
        @forelse ($others as $article)
            <div class="overflow-hidden rounded-2xl bg-white shadow-sm">
                ...
                <div class="p-5">
                    ...
                    <p class="mt-1 text-sm text-gray-500">{{ \Illuminate\Support\Str::limit($article->content, 90) }}</p>
                </div>
            </div>
        @empty
            @if ($featured)
